...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.md", "bin/puma", "bin/pumactl", "docs/config.md", "docs/nginx.md", "ext/puma_http11/extconf.rb", "tools/jungle/README.md", "tools/jungle/init.d/README.md", "tools/jungle/upstart/README.md"]
